...
import com.fallt.controller.SecurityController;
...
class SecurityControllerTest {
    ...
    void whenLogin_thenReturnOk() throws Exception {
        ...
        when(authService.login(LOGIN_REQUEST)).thenReturn(LOGIN_RESPONSE);
    ...
    void whenBlockedUserLogin_thenReturnUnauthorized() throws Exception {
        ...
        when(authService.login(LOGIN_REQUEST)).thenThrow(AuthenticationException.class);
    ...
    void whenLoginWithIncorrectEmail_thenReturnBadRequest() throws Exception {
        ...
        when(authService.login(LOGIN_REQUEST)).thenThrow(EntityNotFoundException.class);
